...
import time  
import regex as re
from data.spark.multiple_webdataset import MultipleWebDataset, collate_fn_with_bicodec, process_single_batch
...
def main():
    ...
    audio_tokenizer = BiCodecTokenizer(args.audio_model_dir, device='cpu')
    ...
    # 使用新的 collate 函数
    data_collator = partial(collate_fn_with_bicodec, 
                          tokenizer=tokenizer,
                          bicodec_tokenizer=audio_tokenizer)
