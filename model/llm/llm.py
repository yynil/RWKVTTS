...
class RWKV7LM(nn.Module):
    def __init__(
        ...
        self.llm = llm
        self.text_embedding = llm.get_input_embeddings()
...
if __name__ == '__main__':
    rwkv_path = "/home/yueyulin/models/rwkv7-1.5B-world/"
    ...
    batch = {"text_token": texts_ids, "text_token_len": texts_length, "speech_token": speech_tokens, "speech_token_len": speech_length}
    output = rwkv7lm(batch,device)
    print(output)